---
title: "Access to HealthCare: Children Health Insurance Program (CHIP) and Medicaid Enrollment Visualized by State - Chris Gottwaldt"
...
server <- function(input, output) {
  ...
  output$state_lines_plot <- renderPlotly({
    ...
    data %>%
      ...
      layout(
        title = "Top 10 Medicaid and CHIP Enrollment States",
